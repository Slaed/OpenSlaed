...
define("_NEW_FAV_1","№");
define("_NEW_FAV_2","Заголовок");
define("_NEW_FAV_3","Функции");
define("_NEW_FAV_4","Показать");
define("_NEW_FAV_5","Инвертировать");
define("_NEW_FAV_6","Максимально допустимое количество фаворитов: ");
define("_NEW_FAV_7",", вы уже добавили: ");
define("_NEW_FAV_8",".<br />Ещё можно добавить: ");
define("_NEW_FAV_9",".<br />Для добавления новых фаворитов удалите хотя бы: ");
define("_NEW_FAV_10","Редактировать");
define("_NEW_FAV_11","Добавить в закладки браузера");
define("_NEW_FAV_12","Удалить");
define("_NEW_FAV_13","Мои закладки");
define("_NEW_FAV_14","Удалить отмеченные");
define("_NEW_FAV_15","Добавить закладку");
define("_NEW_FAV_16","Без описания");
define("_NEW_FAV_17","Добавлять закладки могут только зарегистрированные пользователи!");
define("_NEW_FAV_18","Закладка не добавлена!<br />Введите ссылку на закладку!");
define("_NEW_FAV_19","Закладка не добавлена!<br />У вас слишком много закладок!");
define("_NEW_FAV_20","Закладка не добавлена!<br />Закладка с такой ссылкой у Вас уже существует!");
define("_NEW_FAV_21","Ваша новая закладка добавлена!");
define("_NEW_FAV_22","Закладка не отредактирована!<br />Редактировать закладки могут только зарегистрированные пользователи!");
define("_NEW_FAV_23","Закладка не отредактирована!<br />Введите ссылку на закладку!");
define("_NEW_FAV_24","Закладка не отредактирована!<br />Закладка с такой ссылкой у Вас уже существует!");
define("_NEW_FAV_25","Ваша закладка успешно отредактирована!");
define("_NEW_FAV_26","На данный момент у вас нет ни одной закладки!");
define("_NEW_FAV_27","Закладки не удалены!<br />Удалять закладки могут только зарегистрированные пользователи!");
define("_NEW_FAV_28","Выбранные закладки были удалены!");
define("_NEW_FAV_29","Редактировать закладки могут только зарегистрированные пользователи!");
define("_NEW_FAV_30","Вашей закладки с таким ID не найдено!");
define("_NEW_FAV_31","Закладки доступны только зарегистрированным пользователям!");
define("_NEW_FAV_32","Перейти к закладке");
define("_NEW_FAV_33","Мои последние закладки");
define("_NEW_FAV_34","Ваши последние закладки");
define("_NEW_FAV_35","Номер");
define("_NEW_FAV_36","Удалить из закладок");
define("_NEW_FAV_37","Добавить в закладки");
define("_NEW_FAV_38","Закладки");
define("_NEW_FAV_39","Активировать закладки?");
define("_NEW_FAV_40","Только в подробном просмотре?");
define("_NEW_FAV_41","Показывать плавающую панель?");
define("_NEW_FAV_42","Максимальное количество закладок у пользователя:");
define("_NEW_FAV_43","Количество закладок на странице:");
