...
if ($go==0 && text_filter($op)=='favorite_add') {favorite_add(array('id'=>intval($_GET['id']),'mod'=>text_filter($mod)));die();}
elseif ($go==0 && text_filter($op)=='favorite_del') {favorite_del();die();}
elseif ($go==0 && text_filter($op)=='favorite_edit') {favorite_edit();die();}
elseif ($go==0 && text_filter($op)=='favorite_fast') {favorite_fast();die();}
if ($go == 1) {
	get_lang();
	$ThemeSel = get_theme();
