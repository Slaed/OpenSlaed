...
define("_NEW_RATE_10","Разрешить голосовать только пользователям?");
define("_NEW_RATE_11","История оценок");
define("_NEW_RATE_12","Информация по оценкам на данный момент отсутсвует!");
define("_NEW_RATE_13","От кого");
define("_NEW_RATE_14","Дата");
define("_NEW_RATE_15","Оценка");
define("_NEW_RATE_16","Гость с IP");
define("_NEW_RATE_17","Показать информацию о пользователе");
define("_NEW_RATE_18","Сегодня");
define("_NEW_RATE_19",'Вчера');
define("_NEW_RATE_20",'января,февраля,марта,апреля,мая,июня,июля,августа,сентября,октября,ноября,декабря');
define("_NEW_RATE_21",'Комментарий');
define("_NEW_RATE_22","Кто может просматривать историю оценок:");
define("_NEW_RATE_23","Просмотр истории оценок доступен только пользователям сайта!");
define("_NEW_RATE_24","Запретить комментарии к оценкам?");
define("_NEW_RATE_25","Максимальное количество записей в истории оценок:");
define("_NEW_RATE_26","Только пользователи");
define("_NEW_RATE_27","Все");
define("_NEW_RATE_28","Никто");
define("_NEW_RATE_29","Просмотр истории оценок запрещён!");
define("_NEW_RATE_30","История оценок");
define("_NEW_RATE_31","Настройки");
define("_NEW_RATE_32","Пользователь: ");
define("_NEW_RATE_33","Оценивали");
define("_NEW_RATE_34","Кто");
define("_NEW_RATE_35","Оценка");
define("_NEW_RATE_36","Новость:");
define("_NEW_RATE_37","Файл:");
define("_NEW_RATE_38","Пользователя:");
define("_NEW_RATE_39","Просмотреть:");
define("_NEW_RATE_40","Выбрать всё");
define("_NEW_RATE_41","Удалить выбранные");
define("_NEW_RATE_42","Показать все оценки данной публикации");
define("_NEW_RATE_43","Показать все оценки, который поставил этот пользователь");
define("_NEW_RATE_44","Показать все оценки, которые поставили с данного IP");
define("_NEW_RATE_45","Показать все положительные оценки");
define("_NEW_RATE_46","Показать все отрицательные оценки");
define("_NEW_RATE_47","Показать все оценки из данного модуля");
