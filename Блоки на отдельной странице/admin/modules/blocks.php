...
function blocks_new() {
	...
	."</div>";
	echo "<div class=\"left\">Отображать блок только на этих страницах:<br /><b><small>Каждая страница вводится с новой строчки (без адреса сайта)<br /><br />Пример:</b><br />pages-view-79.html<br />index.php?name=news&op=view&id=32<br />files.html<br /></br /><b>Пример с регуляркой:</b><br />[regexp] index.php\?name=(news|files)&op=view&id=(\d+)</small></div><div class=\"center\"><textarea name=\"uniq\" cols=\"65\" rows=\"15\" class=\"admin\"></textarea></div>";
...
function blocks_edit() {
	...
	."</div>";
	echo "<div class=\"left\">Отображать блок только на этих страницах:<br /><b><small>Каждая страница вводится с новой строчки (без адреса сайта)<br /><br />Пример:</b><br />pages-view-79.html<br />index.php?name=news&op=view&id=32<br />files.html<br /></br /><b>Пример с регуляркой:</b><br />[regexp] index.php\?name=(news|files)&op=view&id=(\d+)</small></div><div class=\"center\"><textarea name=\"uniq\" cols=\"65\" rows=\"15\" class=\"admin\">$uniq</textarea></div>";
