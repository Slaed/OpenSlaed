...
function info() {
	...
	if ($db->sql_numrows($result) > 0) {
 	  ...
 	  $dltrus = new Date_DeltaRussian(); 
 		...
 		list($commts)=$db->sql_fetchrow($db->sql_query("SELECT COUNT(*) FROM `".$prefix."_comment` WHERE `uid`='$user_id'"));
