...
define("_BACK","Назад");
define("_BADREQUEST","Похоже, что Вы ошиблись, набирая адрес страницы. Попробуйте еще раз...");
...
define("_FORBIDDEN","Извините, но сюда Вам доступ запрещен!");
define("_FORUM","Форум");
...
define("_INPUT","Вход");
define("_INTERNAL","Произошла ошибка на сервере. Возможно, это временно. Попробуйте еще раз.");
...
define("_NEW","Новые");
define("_NEWLAST3DAYS","Добавлен в течение 3 дней");
define("_NEWS","Новости");
define("_NEWTHISWEEK","Добавлен в течение недели");
...
define("_NOTFOUND"," <br>Запрашиваемая  вами страница (или файл) не найдена! <br>Возможные причины:<br><div align=\"left\"><ul><li>Вами был неверно набран адрес;</li><li>Данная страница (или файл) была удалена  или перемещена администрацией портала в другое место.</li></ul></div>Попробуйте воспользоваться главным меню или поиском по сайту... Желаем удачи!");
...
define("_OPCAL","Открыть календарь");
...
define("_PDOWN","Спуститься к концу");
...
define("_PUP","Подняться к началу");
...
define("_SELECTASITE","Читать с сайта");
...
define("_SERVICEUNAVIABLE","Данная страница временно недоступна. Попробуйте обратиться позднее...");
...
define("_UNAUTHORIZED","Извините, но доступ сюда разрешен только авторизованным пользователям!");
