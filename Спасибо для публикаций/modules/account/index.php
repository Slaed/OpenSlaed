...
function info() {
	...
	$result = $db->sql_query("SELECT th.count AS thcount, th.thanks AS thanks, u.user_id, u.user_name, u.user_email, u.user_website, u.user_avatar, u.user_regdate, u.user_icq, u.user_occ, u.user_from, u.user_interests, u.user_sig, u.user_viewemail, u.user_aim, u.user_yim, u.user_msnm, u.user_password, u.user_storynum, u.user_blockon, u.user_block, u.user_theme, u.user_newsletter, u.user_lastvisit, u.user_lang, u.user_points, u.user_last_ip, u.user_warnings, u.user_group, u.user_birthday, u.user_gender, u.user_votes, u.user_totalvotes, u.user_field, u.user_agent, g.name, g.rank FROM ".$prefix."_users AS u LEFT JOIN ".$prefix."_groups AS g ON (g.id=u.user_group) LEFT JOIN ".$prefix."_thanks_user AS th ON (th.uid=u.user_id) WHERE user_name='$user_name'");
