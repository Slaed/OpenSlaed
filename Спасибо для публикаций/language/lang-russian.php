...
define("_THANKS_1",'Вы уже ставили "Спасибо" за даннную публикацию!');
define("_THANKS_2",'Ставить "Спасибо" своим публикациям запрещено!');
define("_THANKS_3",'Благодарим, Ваше "Спасибо" учтено!');
define("_THANKS_4",'"Спасибо" для данного модуля отключено!');
define("_THANKS_5","Спасибо!");
define("_THANKS_6",'Ваше "Спасибо" учтено!');
define("_THANKS_7",'Уже сказали "Спасибо"');
define("_THANKS_8",'Показать/Скрыть, сказавших \'Спасибо\'');
define("_THANKS_9","человек|человека|человек");
define("_THANKS_10",'Пока ещё никто не говорил "Спасибо"');
define("_THANKS_11",'Просмотреть профиль');
define("_THANKS_12",'Сказал "Спасибо":');
define("_THANKS_13",'Получил "Спасибо":');
